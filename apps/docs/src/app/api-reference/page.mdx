...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td><code>getSelectionText()</code></td>
      <td>Return the current terminal-owned browser selection, with row-end padding trimmed.</td>
    </tr>
    <tr>
      <td><code>hasSelection()</code></td>
      <td>Check whether the active browser selection belongs to the terminal.</td>
    </tr>
    <tr>
      <td><code>clearSelection()</code></td>
      <td>Clear the active terminal-owned browser selection.</td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Get cell data at a grid position, including terminal column width</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>getScrollbackGeneration(): number</code></td>
      <td>Monotonic scrollback content version for renderer cache invalidation</td>
    </tr>
    <tr>
    ...
    <tr>
      <td><code>getScrollbackLineWrapped(offset): boolean</code></td>
      <td>Check whether a scrollback line soft-wraps into the following line</td>
    </tr>
    <tr>
      <td><code>getRowWrapped(row): boolean</code></td>
      <td>Check whether a visible grid row soft-wraps into the following row</td>
    </tr>
    <tr>
...
interface CellData {
  ...
  width?: 0 | 1 | 2; // 0 = wide spacer, 1 = normal, 2 = wide/fullwidth
}
